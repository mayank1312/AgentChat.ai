...
import { UpdategentDialog } from "../components/update-agent-dialog";
...
export const AgentIdView = ({agentId}:Props) => {
    ...
    const [updateAgentDialogOpen,setUpadetAgentDialogOpen]=useState(false);
   ...
   const handleRemoveAgent=async()=>{
    ...
    return(
        ...
        onOpenChange={setUpadetAgentDialogOpen}
        initialValues={data}
        />
        <div className="flex-1 pb-4 px-4 md:px-8 flex flex-col gap-y-4">
          ...
          agentId={agentId}
          agentName={data.name}
          onEdit={() => setUpadetAgentDialogOpen(true)}
