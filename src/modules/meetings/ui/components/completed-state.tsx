            ...
            <div className="bg-white rounded-lg border px-3">
                <ScrollArea>
                    <TabsList className="p-0 bg-background justify-start rounded-none h-13">
                        <TabsTrigger
                         value="summary"
                         className="text-muted-foreground data-[state=active]:shadow-none rounded-none 
                         bg-background border-b-2 border-transparent data-[state=active]:border-b-primary
                    ...
                    <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
                        ...
                        <div>
                            ...
                            components={{
                                ...
                                code:(props)=>(
                                    <code className="bg-gary-100 px-1 py-0.5 rounded" {...props}/>
                                ),
                                blockquote:(props)=>(
